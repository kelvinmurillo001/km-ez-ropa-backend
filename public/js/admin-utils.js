...
/**
 * 🔚 Cierra la sesión actual limpiando almacenamiento y cookies.
 */
...
/**
 * 🔍 Devuelve el usuario actualmente activo del almacenamiento local
 * @returns {object|null}
 */
export function getUsuarioActivo() {
  try {
    ...
    console.warn("⚠️ Error al recuperar el usuario activo:", err);
    return null;
  }
}
